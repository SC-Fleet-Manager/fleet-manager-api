    ...
    <div id="pg">
        ...
        <main id="pg-main">
            <section class="header">
                <img id="sprite-character-1" src="../img/frontpage/illustrations/character-1.png" alt="">
                <div class="gradient-down"></div>
                <div class="container">
                    <h1>Fleet Manager</h1>
                    <h3>For Star Citizen</h3>
                    <p>
                        Best tool in the verse to manage and share your Organization's and personal fleet
                    </p>

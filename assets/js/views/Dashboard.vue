<template>
    <div class="animated fadeIn">
        <b-row>
            <b-col>
                <b-card header="Card title">
                    <ul>
                        <li v-for="fleet in fleets">{{ fleet.id }}</li>
                    </ul>
        ...
        <b-card>
            ...
            <main-chart-example chartId="main-chart-01" class="chart-wrapper" style="height:300px;margin-top:40px;"
                    ...
                    <b-col sm="6">
                      <Callout variant="info">
                        ...
                        <div class="chart-wrapper" :style="{ top: '-10px'}">
                          &lt;!&ndash;<callout-chart-example :data="[35, 23, 56, 22, 97, 23, 64]" variant="#20a8d8" width="80" height="30" />&ndash;&gt;
...
<script>
    ...
    export default {
        ...
        created() {
            axios.get('/fleets').then(response => {

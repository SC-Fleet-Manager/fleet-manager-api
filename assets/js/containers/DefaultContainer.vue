    ...
    <div class="app">
        <AppHeader fixed>
            ...
            <b-navbar-nav class="ml-auto">
                <b-nav-text v-if="user != null" class="px-3 d-none d-sm-inline-block">Welcome, <img v-if="user.supporter" src="../../img/icon_supporter.svg" alt="Supporter" height="30" /> {{ citizen !== null ? citizen.actualHandle.handle : (user.nickname !== null ? user.nickname : user.email) }}</b-nav-text>

...
class LeaveOrganizationControllerTest extends WebTestCase
{
    /**
     * @test
     */
    public function it_should_leave_the_organization_and_delete_the_member_fleet_and_ships_off_the_orga(): void
    {
        ...
        static::$connection->executeStatement(<<<SQL
                ...
                VALUES ('$memberId', '["ROLE_USER"]', 'Ioni', '2021-01-01T10:00:00Z');
        ...
        static::$client->xmlHttpRequest('POST', "/api/organizations/$orgaId/leave", [], [], [
    ...
    {
        static::$client->xmlHttpRequest('POST', '/api/organizations/00000000-0000-0000-0000-000000000010/leave', [], [], [
            'CONTENT_TYPE' => 'application/json',
        ]);

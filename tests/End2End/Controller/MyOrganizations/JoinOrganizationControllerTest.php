...
class JoinOrganizationControllerTest extends WebTestCase
{
    ...
    public function it_should_join_an_orga_for_logged_user(): void
    {
        ...
        static::xhr('POST', '/api/organizations/00000000-0000-0000-0000-000000000010/join', [], [], [
    ...
    {
        static::xhr('POST', '/api/organizations/00000000-0000-0000-0000-000000000001/join', [], [], [
            'CONTENT_TYPE' => 'application/json',
        ]);

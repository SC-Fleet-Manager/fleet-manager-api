...
class UnjoinOrganizationControllerTest extends WebTestCase
{
    ...
    public function it_should_unjoin_an_orga_for_logged_user(): void
    {
        ...
        static::xhr('POST', '/api/organizations/00000000-0000-0000-0000-000000000010/unjoin', [], [], [
    ...
    {
        static::xhr('POST', '/api/organizations/00000000-0000-0000-0000-000000000001/unjoin', [], [], [
            'CONTENT_TYPE' => 'application/json',
        ]);

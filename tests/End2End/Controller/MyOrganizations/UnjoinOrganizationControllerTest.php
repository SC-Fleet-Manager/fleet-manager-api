...
class UnjoinOrganizationControllerTest extends WebTestCase
{
    /**
     * @test
     */
    public function it_should_unjoin_an_orga_for_logged_user(): void
    {
        static::$connection->executeStatement(<<<SQL
                ...
                VALUES ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000010', true),
                       ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000010', false);
            SQL
        );

        static::$client->xmlHttpRequest('POST', '/api/organizations/00000000-0000-0000-0000-000000000010/unjoin', [], [], [
    ...
    {
        static::$client->xmlHttpRequest('POST', '/api/organizations/00000000-0000-0000-0000-000000000001/unjoin', [], [], [
            'CONTENT_TYPE' => 'application/json',
        ]);

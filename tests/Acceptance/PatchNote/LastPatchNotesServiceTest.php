...
class LastPatchNotesServiceTest extends KernelTestCase
{
    ...
    public function it_should_return_the_last_5_patch_notes_over_6(): void
    {
        ...
        $patchNoteRepository->setPatchNotes([
            new PatchNote(PatchNoteId::fromString('00000000-0000-0000-0000-000000000010'), 'Title 0', 'Body 0', null, new \DateTimeImmutable('2021-01-01T10:00:00+00:00')),
            new PatchNote(PatchNoteId::fromString('00000000-0000-0000-0000-000000000011'), 'Title 1', 'Body 1', null, new \DateTimeImmutable('2021-01-02T10:00:00+00:00')),
    ...
    public function it_should_return_the_only_2_patch_notes_ordered_by_created_date(): void
    {
        ...
        $patchNoteRepository = static::$container->get(PatchNoteRepositoryInterface::class);
        $patchNoteRepository->setPatchNotes([
            new PatchNote(PatchNoteId::fromString('00000000-0000-0000-0000-000000000010'), 'Title 0', 'Body 0', null, new \DateTimeImmutable('2021-01-05T10:00:00+00:00')),
            new PatchNote(PatchNoteId::fromString('00000000-0000-0000-0000-000000000011'), 'Title 1', 'Body 1', null, new \DateTimeImmutable('2021-01-01T10:00:00+00:00')),
        ]);
        ...
        static::assertEquals(new LastPatchNotesOutput(patchNotes: [
            new LastPatchNoteOutput(id: PatchNoteId::fromString('00000000-0000-0000-0000-000000000010'), title: 'Title 0', body: 'Body 0', link: null, createdAt: new \DateTimeImmutable('2021-01-05T10:00:00+00:00')),
            new LastPatchNoteOutput(id: PatchNoteId::fromString('00000000-0000-0000-0000-000000000011'), title: 'Title 1', body: 'Body 1', link: null, createdAt: new \DateTimeImmutable('2021-01-01T10:00:00+00:00')),
        ]), $output);
    }

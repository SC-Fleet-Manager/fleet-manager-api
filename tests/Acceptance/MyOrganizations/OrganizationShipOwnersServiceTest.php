...
class OrganizationShipOwnersServiceTest extends KernelTestCase
{
    ...
    public function it_should_return_list_of_owners_of_an_orga_ship(): void
    {
        ...
        $orgaFleet->createOrUpdateShip(OrganizationShipId::fromString('00000000-0000-0000-0000-000000000020'), MemberId::fromString('00000000-0000-0000-0000-000000000002'), 'Avenger', 'https://example.org/avenger_1.jpg', 3, new \DateTimeImmutable('2021-01-02T10:00:00Z'));
        $orgaFleet->createOrUpdateShip(OrganizationShipId::fromString('00000000-0000-0000-0000-000000000020'), $memberId, 'avênger', null, 2, new \DateTimeImmutable('2021-01-03T10:00:00Z'));
        $orgaFleet->createOrUpdateShip(OrganizationShipId::fromString('00000000-0000-0000-0000-000000000021'), $memberId, 'Mercury Star Runner', null, 2, new \DateTimeImmutable('2021-01-04T10:00:00Z'));

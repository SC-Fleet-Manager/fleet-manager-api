...
class DisbandOrganizationServiceTest extends KernelTestCase
{
    ...
    public function it_should_disband_the_organization_and_delete_its_fleet_and_ships(): void
    {
        ...
        $orgaFleet->createOrUpdateShip(OrganizationShipId::fromString('00000000-0000-0000-0000-000000000020'), $founderId, 'Avenger', null, 2, new \DateTimeImmutable('2021-01-02T10:00:00Z'));
        $orgaFleet->createOrUpdateShip(OrganizationShipId::fromString('00000000-0000-0000-0000-000000000020'), $memberId, 'Avenger', 'https://example.org/avenger_1.jpg', 3, new \DateTimeImmutable('2021-01-03T10:00:00Z'));

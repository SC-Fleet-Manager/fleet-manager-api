...
final class Version20190607202117 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE citizen CHANGE nickname nickname VARCHAR(255) DEFAULT NULL, ADD count_redacted_organizations INT NOT NULL, ADD redacted_main_orga TINYINT(1) NOT NULL, DROP organisations');
    ...
    {
        $this->addSql('ALTER TABLE citizen ADD organisations JSON NOT NULL, CHANGE nickname nickname VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP count_redacted_organizations, DROP redacted_main_orga');

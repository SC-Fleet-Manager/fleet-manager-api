...
final class Version20210404204239 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        $this->addSql('CREATE COLLATION en_strict (provider=icu, locale=\'en@colStrength=primary;colAlternate=shifted\', deterministic=false)');
        $this->addSql('CREATE TABLE fleets (user_id UUID NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(user_id))');
        ...
        $this->addSql('CREATE TABLE ships (id UUID NOT NULL, fleet_id UUID DEFAULT NULL, name VARCHAR(32) COLLATE en_strict NOT NULL, image_url VARCHAR(1023) DEFAULT NULL, quantity INT DEFAULT 1 NOT NULL, PRIMARY KEY(id))');
